...
export const routes: Routes = [
  ...
  {path: 'voter_search', loadComponent: () => import('./voter-search/votersearch').then(m => m.VoterSearchComponent) },
  {
    ...
    children: [
      ...
      {path: 'profile/:id', loadComponent: () => import('./userregistration/userregistration').then(m => m.UserRegistration) },
      {path: 'vote', loadComponent: () => import('./voting/voting').then(m => m.Voting) },
      {path: 'election_info', loadComponent: () => import('./election-info/election-info').then(m => m.ElectionInfo) },
      {path: 'voting_history', loadComponent: () => import('./voting-history/voting-history').then(m => m.VotingHistory) },
      {path: 'publish_result', loadComponent: () => import('./publish-result/publish-result').then(m => m.PublishResult) },
      {path: 'show_result', loadComponent: () => import('./result/result').then(m => m.Result) },
      {path : 'management_approval', loadComponent: () => import('./management-approval/management-approval').then(m => m.ManagementApproval) },
    ]
  },
