...
@Component({
  ...
  templateUrl: './election-info.html',
  styleUrl: './election-info.scss',
})

export class ElectionInfo implements OnInit {
  ...
  loadElections() {
    ...
    this.electionService.getEligibleElection().subscribe(response => {
