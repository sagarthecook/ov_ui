...
@Component({
  ...
  imports: [
    ...
    templateUrl: './management-approval.html',
  styleUrl: './management-approval.scss',
})

export class ManagementApproval implements OnInit {
  ...
  loadManagementUsers(): void {
    this.loading = true;
    debugger; 
    this.userService.getManagementUserDetailsList().subscribe(
